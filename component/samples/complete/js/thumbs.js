	...
	thumbs : function () {
		...
		this.update = function () {
			...
			if (this.properties.source.value == 1 && this.files.length > 1) {
				this.default_file = this.folder + utils.ReadINI(this.ini_file, 'Defaults', utils.ReplaceIllegalChars(this.artist, false));
		...
		this.set_default = function (t) {
			utils.WriteINI(this.ini_file, 'Defaults', utils.ReplaceIllegalChars(this.artist, false), t);
			this.update();
		}
		...
		this.download = function () {
			...
			var base = this.folder + utils.ReplaceIllegalChars(this.artist, false) + '_';
		...
		this.exts = ['webp', 'jpg', 'jpeg', 'png', 'gif'];
		this.folder = '';
		this.default_file = '';
		this.artist = '';
		this.img = null;
