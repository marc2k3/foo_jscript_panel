...
#define DEFINE_ID_NAME_ENTRY(x) { CallbackID::x, PFC_WIDESTRING(#x) }

struct CallbackIDName
{
	CallbackID id;
	std::wstring name;
};

static const std::vector<CallbackIDName> CallbackIDNames =
{
	...
	DEFINE_ID_NAME_ENTRY(on_locations_added),
